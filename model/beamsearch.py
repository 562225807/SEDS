...
class BeamSearchDecodeCell(object):
    ...
    def __init__(self, embeddings, cell, dec_init_states,
        ...
        if hasattr(self._cell, "_ex_emb") and self._cell._ex_emb is not None:
            self._cell._ex_emb = tf.gather(self._cell._ex_emb, indices)
...
class ECMBeamSearchDecodeCell(object):
    ...
    def __init__(self, embeddings, cell, dec_init_states, output_layer,
        ...
        if hasattr(self._cell, "_mmmemory"):
            self._cell._mmmemory = tf.gather(self._cell._mmmemory, indices)

        if hasattr(self._cell, "_person_lexicons"):
            self._cell._person_lexicons = tf.gather(self._cell._person_lexicons, indices)

        if hasattr(self._cell, "_per_emb"):
            self._cell._per_emb = tf.gather(self._cell._per_emb, indices)
